...
fn get_saved_foreground() -> (isize, isize, isize) {
    get_saved_color("foreground", 20)
}
fn save_foreground(color: &(isize, isize, isize)) {
    save_color("foreground", color)
}
fn get_saved_background() -> (isize, isize, isize) {
    get_saved_color("background", 200)
}
fn save_background(color: &(isize, isize, isize)) {
